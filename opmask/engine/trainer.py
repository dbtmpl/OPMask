...
from ..evaluation import PartiallySupervisedEvaluator


class GeneralTrainer(SimpleTrainer):
    ...
    def build_hooks(self):
        ...
        if comm.is_main_process():
            ...
            ret.append(hooks.PeriodicWriter(self.build_writers(), period=self.cfg.EXP.PRINT_PERIOD))
        return ret
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        ...
        if evaluator_type in ["coco"]:
            evaluator_list.append(PartiallySupervisedEvaluator(dataset_name, cfg, True, output_folder))
